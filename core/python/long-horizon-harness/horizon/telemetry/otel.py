...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        commit_sha = env_str("COMMIT_SHA", "dev")
        os.environ.setdefault(
            "OTEL_RESOURCE_ATTRIBUTES",
            f"service.namespace=lha,service.version={commit_sha}",
        )
        path = env_str("GENAI_TELEMETRY_PATH", "completions")
        os.environ.setdefault(
